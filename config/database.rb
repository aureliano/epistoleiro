...
database_name = case Padrino.env
  when :development then 'epistoleiro_development'
  when :production  then 'epistoleiro_production'
  when :test        then 'epistoleiro_test'
end
...
#     sessions:
#       default:
#         database: epistoleiro_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: epistoleiro_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: epistoleiro_test
#         hosts:
#           - localhost:27017
#
#
