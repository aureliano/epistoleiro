Feature: Activate an account
  ...
  Scenario: An inactive user tries to active an account providing a wrong activation key
  	Given there is an inactive user with nickname 'dummy' and activation key '5daf87sdf45sd1xcv'
  	When I go to activation page for nickname 'dummy' and activation key '000000000000'
  ...
  Scenario: An active user go to activation page
  	...
  	When I go to activation page for nickname 'dummy' and activation key '5daf87sdf45sd1xcv'
